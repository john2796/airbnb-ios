...
struct DestinationSearchView: View {
    ...
    var body: some View {
        VStack {
            // nav controls
            NavigationControlsView(showView: $showView, viewModel: viewModel)
            
            // location search
            LocationSearch(destination: $viewModel.searchLocation, selectedOption: selectedOption, viewModel: viewModel, showView: $showView)
                .onTapGesture {
...
private struct LocationSearch: View {
